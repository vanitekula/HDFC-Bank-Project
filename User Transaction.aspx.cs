...
namespace WebApplication39
{
    public partial class User_Transaction : System.Web.UI.Page
    {
        ...
        {
            // Transfer
            if (new BusinessLogic().TransferFunds(new Trans() { FromAccount = Label2.Text, ToAccount = TextBox1.Text, Amount = int.Parse(TextBox2.Text) }))
            {
                Label6.Text = "Amount Transfered Sucessfully......";
            }
            else
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Label7.Text = "Password changed sucessufully";
            }
            else
            {
                Label7.Text = "Failed";
